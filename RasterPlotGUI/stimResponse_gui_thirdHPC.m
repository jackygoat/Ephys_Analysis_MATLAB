function create_gui()
    ...
    load([subj '_HPC_stoch_response_FR.mat'], 'percentageSTIM_excite_cortex', 'percentageSTIM_excite_hipp', 'percentageSTIM_inhib_cortex', 'percentageSTIM_inhib_hipp');
    load(['F344AD_' subj '_HPC_TimeStamps.mat'], 'Trial_pulse');
    load([subj '_HPC__FilterCluster_SUMU.mat'], 'clusTab');
    load([subj '_HPC_layered_PExcitePInhib.mat'], 'excite_cortex_ID', 'excite_hipp_ID', 'inhib_cortex_ID', 'inhib_hipp_ID');
